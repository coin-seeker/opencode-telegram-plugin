...
export function isEventQuestionReplied(event: { type: string; properties?: Record<string, unknown> }): event is EventQuestionReplied {
...
export async function handleQuestionReplied(event: EventQuestionReplied, ctx: EventHandlerContext): Promise<void> {
