...
Use this guide to install `@coinseeker/opencode-telegram-plugin@1.0.12` as an OpenCode npm package plugin.
...
Package: @coinseeker/opencode-telegram-plugin@1.0.12
...
3. Add "@coinseeker/opencode-telegram-plugin@1.0.12" to ~/.config/opencode/opencode.json under the singular "plugin" array, preserving existing plugins.
...
{
  "plugin": [
    "@coinseeker/opencode-telegram-plugin@1.0.12"
  ]
}
```
...
- Confirm the npm package name is exactly `@coinseeker/opencode-telegram-plugin@1.0.12`.
