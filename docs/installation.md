...
Use this guide to install `@coinseeker/opencode-telegram-plugin@1.0.9` as an OpenCode npm package plugin.
...
Package: @coinseeker/opencode-telegram-plugin@1.0.9
...
3. Add "@coinseeker/opencode-telegram-plugin@1.0.9" to ~/.config/opencode/opencode.json under the singular "plugin" array, preserving existing plugins.
...
{
  "plugin": [
    "@coinseeker/opencode-telegram-plugin@1.0.9"
  ]
}
```
...
- Confirm the npm package name is exactly `@coinseeker/opencode-telegram-plugin@1.0.9`.
