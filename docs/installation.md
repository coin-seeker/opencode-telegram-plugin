...
Use this guide to install `@coinseeker/opencode-telegram-plugin@1.1.6` as an OpenCode npm package plugin.
...
Package: @coinseeker/opencode-telegram-plugin@1.1.6
...
3. Add "@coinseeker/opencode-telegram-plugin@1.1.6" to ~/.config/opencode/opencode.json under the singular "plugin" array, preserving existing plugins.
...
- Confirm the npm package name is exactly `@coinseeker/opencode-telegram-plugin@1.1.6`.
