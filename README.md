...
Control and monitor OpenCode from Telegram. Install it as the npm package `@coinseeker/opencode-telegram-plugin@1.0.11`, then configure your Telegram bot credentials in a private local env file.
