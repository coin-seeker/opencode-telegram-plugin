...
To update an existing install, replace the previous pinned package entry with `@coinseeker/opencode-telegram-plugin@1.2.0`, keep the rest of the `plugin` array unchanged, and restart OpenCode.
